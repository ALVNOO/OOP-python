...
# Fungsi untuk tambah dan hapus item
def add_item(items):
    print("\nTambah Item:")
    title = input("Judul: ")
    ...
    if choice == "1":
        ...
        items.append(Buku(title, publication_date, pages, rating, author))
    elif choice == "2":
        editionNumber = input("Nomor Edisi: ")
        items.append(Majalah(title, publication_date, pages, rating, editionNumber))
    elif choice == "3":
        publisher = input("Penerbit: ")
        items.append(Koran(title, publication_date, pages, rating, publisher))
    else:
